...
{
  route_table[0].dest = inet_addr("192.168.80.2");
  route_table[0].gateway = inet_addr("192.168.80.130");
...
int main()
{
  ...
  while (1)
  {
    ...
    // 目的主机的 MAC 地址。）
    unsigned char target_mac[ETH_ALEN] = {0x00, 0x0c, 0x29, 0x5c, 0x8d, 0xee}; //
    // 替换为实际的目标 MAC 地址
